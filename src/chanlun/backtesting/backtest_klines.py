...
class BackTestKlines(MarketDatas):
    ...
    def _cal_start_date_by_frequency(self, start_date: datetime, frequency) -> str:
        ...
        market_days_freq_maps = {
            'a': {
                'w': 10000, 'd': 10000, 
                '120m': 500, '4h': 500, '60m': 100, '30m': 700, 
                '15m': 350, '5m': 600, '1m': 100,
            },
            'hk': {
                'd': 5000, '120m': 500, '4h': 500, 
                '60m': 100, '30m': 100, '15m': 50, 
                '5m': 25, '1m': 5,
            },
            'us': {
                'd': 5000, '120m': 2000, '60m': 1000, '30m': 500, '15m': 250, 
                '10m': 200, '5m': 80, '1m': 15,
            },
            'currency': {
                'w': 2000, 'd': 2000, '4h': 1000, '120m': 500, 
                '60m': 210, '30m': 105, '15m': 55, '10m': 25, '8m': 25, '5m': 18, '1m': 4,
            },
            'futures': {
                'd': 5000, '120m': 500, '4h': 500, 
